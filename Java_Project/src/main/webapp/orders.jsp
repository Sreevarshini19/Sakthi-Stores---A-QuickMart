...
<main>
   ...
   String query = "SELECT o.id, o.mobile_no, o.total_amount, o.datetime, p.payment_mode, p.status FROM orders o  JOIN payments p ON o.id = p.orderid";
            ...
            <tr>
                ...
                <td><%= mobileNo %></td>
                <td><%= totalAmount %></td>
                <td><%= new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(datetime) %></td>
                <td><%= paymentMode %></td>
                <td><%= paymentStatus %></td>
            </tr>
            <%
