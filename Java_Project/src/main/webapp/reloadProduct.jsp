...
<main>
    ...
    %>
    <form action="ReloadProducts" method="post">
        ...
        <select name="product" required>
            ...
            <%
                ...
                try {
                    ...
                    out.println("<p class='error'>Error in closing resources: " + ex.getMessage() + "</p>");
                }
            }
            %>
        </select>
        ...
        <input type="number" name="rate" placeholder="Enter price" required />

        <label>Enter Quantity</label>
        <input type="number" name="quantity" placeholder="Enter quantity" required />
		<label>Product Threshold</label>
        <input type="number" name="to_notify" placeholder="Enter product threshold for reloading" required />
