        ...
        <table>
            ...
            <tbody>
                <% 
                    ...
                    try {
                        conn = DbConnection.getConnected(); // Assuming you have a class to handle DB connection
                        String query = "SELECT p.id, p.product_name, p.kind, p.available, p.to_notify " + 
                                       "FROM products p " +
                                       "WHERE p.available <= (SELECT e.to_notify FROM products e WHERE p.product_name = e.product_name)";
                        ...
                        while (rs.next()) {
                            ...
                            int toNotify = rs.getInt("to_notify");
